...
-- (Subgroup+order для alloy-mixing рецептов — в tweaks/recipe/angels-smelting-extended-port.lua)
for name, recipe in pairs(data.raw.recipe) do
	if name:match("^molten%-.*%-alloy%-mixing") or name:match("^molten%-.*%-remelting$") then
